...
\begin{document}
	\begin{textblock*}{5cm}(15.5cm,0.2cm) 
		...
		\begin{tcolorbox}[colframe=white, colback=white, sharp corners]
			\fontfamily{phv}\selectfont \centering\footnotesize \textit{Last update: Mar 2026} \normalsize\normalfont
		\end{tcolorbox}
	\end{textblock*}
	...
	\textit{Researcher in nonlinear control and robotics, with a focus on safety-critical control, model predictive control, and dynamic robotic systems.}
	...
	\begin{soloitemize}
		...
		\item Conformal-Seeded Hybrid Inverse Kinematics for Offset Redundant Manipulators
			...
			\noindent\textit{Submitted manuscript}
			\par\vspace{0.3em}
			\noindent\textit{\hl{\textbf{D.C. Vu}}, V.T. Nguyen, D.H. Nguyen, M.C. Nguyen, T.V. Trung, A. Kugi, and M.N. Vu}
	\end{soloitemize}
		% work experience
	...
	{\begin{soloitemize}
			\item Developed standardized pipelines for robot modeling, kinematic calibration, and system identification for industrial robotic systems.
			\item Designed and implemented motion planning and control algorithms for humanoid robots.
			\item Contributed to research activities, with papers submitted to \textit{IROS 2026} and \textit{IEEE-TASE}, \textit{IEEE RA-L}.
	\end{soloitemize}}
