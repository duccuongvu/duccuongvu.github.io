...
%		}
	...
	\activities{Invited review for}{\textit{Nonlinear Dynamics, IEEE Access}}
...
%	\conference{International Conference on Intelligent Systems and Networks (Springer ICISN 2023)}{\textit{Hanoi, Vietnam}}
	...
	% ================= Skills Section =================
	\section*{Skills}
		\skill{Programming} {Python, C/C++, MATLAB for algorithm development and embedded robotics.}
		\skill{Modeling \& Simulation} {Simulink, Simscape Multibody, MuJoCo for kinematics, dynamics, and control validation.}
		\skill{Control \& Optimization} {Rigid-body dynamics, nonlinear control, MPC, estimation/observer design, optimization, ....}
		\skill{Robotics Systems} {ROS2, EtherCAT, real-time Linux, embedded systems, automation.}
		\skill{Engineering Tools} {Git, SolidWorks, PCB design, experimental platform development.}
