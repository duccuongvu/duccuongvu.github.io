...
\begin{document}
	...
	{\hl{\textbf{D.C. Vu}}$^\dagger$, S. Tran$^\dagger$, T.L. Nguyen, and D.C. Hoang \hfill$^\dagger$: equally contribution}
	...
	{\hl{\textbf{D.C. Vu}}, D.H. Nguyen, M.N. Vu, and T.L. Nguyen}
	...
	{M.D. Pham, \hl{\textbf{D.C. Vu}}, T.T.H. Nguyen, T.V.A. Nguyen, M.N. Vu, and T.L. Nguyen}
	...
	{A novel approach of Consensus-based Finite-time DSMC for Stewart platform manipulators motion tracking}
	{\hl{\textbf{D.C. Vu}}, D.H. Nguyen, and T.L. Nguyen}
	{10.1016/j.rineng.2024.103872}
	
	 \sepspace
	
	 \publication{Journal}
	 {IET Cyber-Systems and Robotics (SCIE Q3) (2025)}
	 ...
	 {T.T.H. Nguyen, \hl{\textbf{D.C. Vu}}, M.D. Pham, T.V.A. Nguyen, and T.L. Nguyen}
	 {10.1049/csy2.70045}

	\sepspace
	\publication{Journal}
	{International Journal of Robust and Nonlinear Control - IJRNC (SCIE Q1) (2024)}
	...
	{\hl{\textbf{D.C. Vu}}, M.D. Pham, T.T.H. Nguyen, T.V.A. Nguyen, and T.L. Nguyen}
	{10.1002/rnc.7358}
	...
	\publication{Under-review manuscript}
	{Submitted manuscript}
	{Decentralized Control Strategy with Consistent Joint-to-Actuator Control Law for Parallel Mechanisms on a Humanoid Platform}
	{T.V. Trung, V.T. Nguyen, \hl{\textbf{D.C. Vu}}, D.H. Nguyen, M.C. Nguyen, and M.N. Vu}
	{10.1002/rnc.7358}
	...
	\publication{Under-review manuscript}
	{Submitted manuscript}
	{Adaptive Whole-Body MPC with Optimal Posture Planning for Humanoid Robots under Unknown Payloads}
	{M.C. Nguyen$^\dagger$, \hl{\textbf{D.C. Vu$^\dagger$}}, V.A. Vu, T. Nguyen, D.T. Pham, M.H. Phung, A.V. Ngo, and M.N. Vu \hfill$^\dagger$: equally contribution}
	{}
	...
	{\hl{\textbf{D.C. Vu}}, V.T. Nguyen, D.H. Nguyen, M.C. Nguyen, T.V. Trung, A. Kugi, and M.N. Vu}
	{}
		% work experience
	...
	{\begin{soloitemize}
			\item Conduct pipeline for robot model standardization, kinematics calibration, system identification, and advanced control algorithm for industrial robots.
			\item Design motion planning and motion control for VinRobotics humanoids robot, conduct scientific papers which are submitted to IROS2026 and IEEE Transaction on Mechatronics.
	\end{soloitemize}}
%	
	\sepspace
...
%	\conference{International Conference on Intelligent Systems and Networks (Springer ICISN 2023)}{\textit{Hanoi, Vietnam}}
	...
	\section*{Skills}
		...
		\skill{Engineering Tools} {Git, ROS2, IgH EtherCAT, real-time Linux, Acados, CasADI, Pinocchio, MuJoCo, Simulink, Simscape, SolidWorks, Motion Capture system, PCB design, etc.}
		\skill{Research} {Scientific writing, publications, presentations, literature analysis, experimental validation.}
