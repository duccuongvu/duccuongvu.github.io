...
\newcommand{\skill}[2]{%
	...
	\parbox{2.5\spacebox}{\textbf{#1}} #2 \par\vspace{0.15cm}
}
...
\begin{document}
	...
	\begin{minipage}[c]{0.3\textwidth}
		\includegraphics[width=\linewidth]{hexapod.png} % Replace with your image file
	\end{minipage}
	\sepspace
	...
	\begin{minipage}[c]{0.30\textwidth}
		\includegraphics[width=\linewidth]{ProjectTD.png} % Replace with your image file
	\end{minipage}
	...
	\begin{minipage}[c]{0.3\textwidth}
		\includegraphics[width=\linewidth]{IEEEAccess.png} % Replace with your image file
	\end{minipage}
	\hfill
	\noindent\begin{minipage}[c]{0.68\textwidth}
	...
	% Second publication block
	\begin{minipage}[c]{0.3\textwidth}
		\includegraphics[width=\linewidth]{RIENG.png} % Replace with your image file
	\end{minipage}
	\hfill
	\begin{minipage}[c]{0.68\textwidth}
	...
	\sepspace
	% Third publication block
	\begin{minipage}[c]{0.3\textwidth}
		\includegraphics[width=\linewidth]{RNC.png} % Replace with your image file
	\end{minipage}
	\hfill
	\begin{minipage}[c]{0.68\textwidth}
