...
% Numbered publication entry (countdown numbering, APA-style citation)
\newcommand{\pubitem}[2]{%
	\noindent\hangindent=2em\hangafter=1 \textbf{[#1]}~#2\par\vspace{0.6em}%
}
...
\newlength{\awardlabelwidth}
\settowidth{\awardlabelwidth}{\textbf{Master, PhD Scholarship Programme}}

\newcommand{\award}[2]{%
	\noindent
	\parbox[t]{\awardlabelwidth}{\raggedright\textbf{#1}}%
	\hspace{0.75em}%
	\parbox[t]{\dimexpr\linewidth-\awardlabelwidth-0.75em\relax}{\textit{#2}}\par
	\vspace{0.5em}
}
...
%	\end{textblock*}
	...
	\work{Ph.D. in Electrical and Electronic Engineering}
	{Aug 2026 - present}
	{\textit{Supervised by \href{https://scholar.google.com/citations?user=Fmrv3J8AAAAJ&hl=en}{\textit{Prof. Lihua Xie}}} \hfill {Nanyang Technological University (\href{https://www.ntu.edu.sg/}{NTU})}, Singapore}
	{}

	\work{Master Degree in Control Engineering and Automation}
	{Jul 2024 - Jul 2026}
	{\textit{Supervised by \href{https://scholar.google.com/citations?user=MlJ_2-wAAAAJ&hl=en}{\textit{Prof. Tung Lam Nguyen}}} \hfill Hanoi Univ of Science and Technology (\href{https://hust.edu.vn/en/}{HUST}), Hanoi, Vietnam}
	{}

	\work{Bachelor Degree in Control Engineering and Automation}
	{Oct 2020 - Apr 2024}
	{\textit{Supervised by \href{https://scholar.google.com/citations?user=MlJ_2-wAAAAJ&hl=en}{\textit{Prof. Tung Lam Nguyen}}} \hfill Hanoi Univ of Science and Technology (\href{https://hust.edu.vn/en/}{HUST}), Hanoi, Vietnam}
	{}
	...
	\pubitem{6}{Nguyen, T. T. H., {\textbf{Vu, D. C.}}, Pham, M. D., Nguyen, T. L., \& Nguyen, T. V. A. (2026). Unifying hierarchical sliding mode control and control barrier function for tilt angle constraint of a ball-balancing robot. \textit{IET Cyber-Systems and Robotics}. [\href{https://doi.org/10.1049/csy2.70045}{pdf}]}

	\pubitem{5}{{\textbf{Vu, D. C.}}$^\dagger$, Tran, S.$^\dagger$, Nguyen, T. L., \& Hoang, D. C. (2025). Glocal trajectory generation and tracking control for AUVs with optimal coverage sensor networks. \textit{Ocean Engineering}. [\href{https://doi.org/10.1016/j.oceaneng.2025.122902}{pdf}] \hfill{\footnotesize $^\dagger$equal contribution}}

	\pubitem{4}{{\textbf{Vu, D. C.}}, Nguyen, D. H., Vu, M. N., \& Nguyen, T. L. (2025). Lagrangian-based modeling and safety-critical controls for Stewart platforms under marine operations. \textit{Ocean Engineering}, 340, 122142. [\href{https://doi.org/10.1016/j.oceaneng.2025.122142}{pdf}]}

	\pubitem{3}{Pham, M. D., {\textbf{Vu, D. C.}}, Nguyen, T. T. H., Nguyen, T. V. A., Vu, M. N., \& Nguyen, T. L. (2025). CBFs-based model predictive control for obstacle avoidance with tilt angle limitation for ball-balancing robots. \textit{IEEE Access}. [\href{https://doi.org/10.1109/ACCESS.2025.3567474}{pdf}]}

	\pubitem{2}{{\textbf{Vu, D. C.}}, Nguyen, D. H., \& Nguyen, T. L. (2024). A novel approach of consensus-based finite-time distributed sliding mode control for Stewart platform manipulators motion tracking. \textit{Results in Engineering}. [\href{https://doi.org/10.1016/j.rineng.2024.103872}{pdf}]}

	\pubitem{1}{{\textbf{Vu, D. C.}}, Pham, M. D., Nguyen, T. T. H., Nguyen, T. V. A., \& Nguyen, T. L. (2024). Time-optimal trajectory generation and observer-based hierarchical sliding mode control for ballbots with system constraints. \textit{International Journal of Robust and Nonlinear Control}. [\href{https://doi.org/10.1002/rnc.7358}{pdf}]}
