...
\begin{document}
	...
	\begin{soloitemize}
		...
		\sepspace
		\item Conformal-Seeded Hybrid Inverse Kinematics for Offset Redundant Manipulators
			\par\vspace{0.3em}
			\noindent\textit{Submitted manuscript}
			\par\vspace{0.3em}
	...
	{Sep 2025 - Jul 2026}
	{Full-time, supervised by \href{https://scholar.google.com/citations?user=qyExc4QAAAAJ&hl=en}{\textit{PhD. Minh Nhat Vu}}\hfill Hanoi, Vietnam}
	{\begin{soloitemize}
			...
			\item Developed model-based control for dual-arm humanoid robots: fuzzy-based adaptive compliant control, computed torque control, gravity/friction compensation, and singular perturbation-based methods.
