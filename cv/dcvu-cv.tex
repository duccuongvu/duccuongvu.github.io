...
\newcommand{\publication}[5]{%
	\noindent $\star$ \hspace{0.1em} #3 \par
	\vspace{0.3em} 
	\noindent\hspace{2em}\textit{#2} [\href{https://doi.org/#5}{pdf}] \par
	\vspace{0.3em}
	\noindent\hspace{2em}\textit{#4}
}
...
\begin{document}
	\begin{textblock*}{5cm}(15.5cm,0.2cm) 
		\centering
		\begin{tcolorbox}[colframe=white, colback=white, sharp corners]
			\fontfamily{phv}\selectfont \centering\footnotesize \textit{Last update: Jul 2026} \normalsize\normalfont
		\end{tcolorbox}
	\end{textblock*}
	
	
	\name{Duc-Cuong Vu}{\href{mailto:vdcuong2002@gmail.com}{vdcuong2002@gmail.com}}{\href{https://duccuongvu.github.io}{https://duccuongvu.github.io}}
	

	\sepspace
	
	
	\textit{First-year PhD student at Nanyang Technological University (NTU), Singapore, researching nonlinear control and robotics, with a focus on safety-critical control, model predictive control, and dynamic robotic systems.}
	...
	\education{Ph.D. in Electrical and Electronic Engineering}{Aug 2026 - present}{Nanyang Technological University (\href{https://www.ntu.edu.sg/}{NTU}), Singapore
	}
	{
		{Funded by:} \textit{NTU Research Scholarship}
	}

	\sepspace

	\education{Master of Sci. in Control Engineering and Automation}{Jul 2024 - Jul 2026}{%School of Electrical - Electronics Engineering,
		Hanoi University of Science and Technology (\href{https://hust.edu.vn/en/}{HUST}),
		%\hfill Hanoi, Vietnam
	}
	{
		% \begin{soloitemize}
			\textbf{Thesis:} \textit{Design control structures for parallel platforms in maritime applications} \\
			{Funded by:} \textit{Master, PhD Scholarship Programme of Vingroup Innovation Foundation (\href{https://vinif.org/en/}{VinIF})}
		% \end{soloitemize}
	}

	\sepspace

	\education{Bachelor of Sci. in Control Engineering and Automation}
	{Oct 2020 - Apr 2024}{
	...
	{
	% {\begin{soloitemize}
			{Excellent degree}, GPA: 3.71/4 (Rank: 22/499, top 5\%). Finished the 4-year BSc program in {just 3.5 years}.
	...
	\begin{soloitemize}
		\item Glocal trajectory generation and tracking control for AUVs with optimal coverage sensor networks
			\par\vspace{0.3em}
			\noindent\textit{Ocean Engineering (SCIE Q1) (2025)} [\href{https://doi.org/10.1016/j.oceaneng.2025.122902}{pdf}]
			\par\vspace{0.3em}
			\noindent\textit{\hl{\textbf{D.C. Vu}}$^\dagger$, S. Tran$^\dagger$, T.L. Nguyen, and D.C. Hoang \hfill$^\dagger$: equally contribution}
		\sepspace
		\item Lagrangian-based modeling and safety-critical controls for Stewart platforms under marine operations
			\par\vspace{0.3em}
			\noindent\textit{Ocean Engineering (SCIE Q1) (2025)} [\href{https://doi.org/10.1016/j.oceaneng.2025.122142}{pdf}]
			\par\vspace{0.3em}
			\noindent\textit{\hl{\textbf{D.C. Vu}}, D.H. Nguyen, M.N. Vu, and T.L. Nguyen}
		\sepspace
		\item CBFs-based Model Predictive Control for Obstacle Avoidance with Tilt Angle Limitation for Ball-Balancing Robots
			\par\vspace{0.3em}
			\noindent\textit{IEEE Acess (SCIE Q2) (2025)} [\href{https://doi.org/10.1109/ACCESS.2025.3567474}{pdf}]
			\par\vspace{0.3em}
			\noindent\textit{M.D. Pham, \hl{\textbf{D.C. Vu}}, T.T.H. Nguyen, T.V.A. Nguyen, M.N. Vu, and T.L. Nguyen}
		\sepspace
		\item A novel approach of Consensus-based Finite-time DSMC for Stewart platform manipulators motion tracking
			\par\vspace{0.3em}
			\noindent\textit{Results in Engineering (ESCI Q1) (2025)} [\href{https://doi.org/10.1016/j.rineng.2024.103872}{pdf}]
			\par\vspace{0.3em}
			\noindent\textit{\hl{\textbf{D.C. Vu}}, D.H. Nguyen, and T.L. Nguyen}
		\sepspace
		\item Unifying Hierarchical Sliding Mode Control and Control Barrier Function for Tilt Angle Constraint of a Ball-Balancing Robot
			\par\vspace{0.3em}
			\noindent\textit{IET Cyber-Systems and Robotics (SCIE Q3) (2025)} [\href{https://doi.org/10.1049/csy2.70045}{pdf}]
			\par\vspace{0.3em}
			\noindent\textit{T.T.H. Nguyen, \hl{\textbf{D.C. Vu}}, M.D. Pham, T.V.A. Nguyen, and T.L. Nguyen}
		\sepspace
		\item Time-optimal trajectory generation and observer-based hierarchical sliding mode control for ballbots with system constraints
			\par\vspace{0.3em}
			\noindent\textit{International Journal of Robust and Nonlinear Control - IJRNC (SCIE Q1) (2024)} [\href{https://doi.org/10.1002/rnc.7358}{pdf}]
			\par\vspace{0.3em}
			\noindent\textit{\hl{\textbf{D.C. Vu}}, M.D. Pham, T.T.H. Nguyen, T.V.A. Nguyen, and T.L. Nguyen}
	\end{soloitemize}
	...
	\begin{soloitemize}
		\item Decentralized Control Strategy with Consistent Joint-to-Actuator Control Law for Parallel Mechanisms on a Humanoid Platform
			\par\vspace{0.3em}
			\noindent\textit{Submitted manuscript} [\href{https://doi.org/10.1002/rnc.7358}{pdf}]
			\par\vspace{0.3em}
			\noindent\textit{T.V. Trung, V.T. Nguyen, \hl{\textbf{D.C. Vu}}, D.H. Nguyen, M.C. Nguyen, and M.N. Vu}
		\sepspace
		\item Adaptive Whole-Body MPC with Optimal Posture Planning for Humanoid Robots under Unknown Payloads
			\par\vspace{0.3em}
			\noindent\textit{Submitted manuscript}
			\par\vspace{0.3em}
			\noindent\textit{M.C. Nguyen$^\dagger$, \hl{\textbf{D.C. Vu$^\dagger$}}, V.A. Vu, T. Nguyen, D.T. Pham, M.H. Phung, A.V. Ngo, and M.N. Vu \hfill$^\dagger$: equally contribution}
		\sepspace
		\item Real-time Conformal-Seeded Hybrid Inverse Kinematics for Offset Redundant Manipulators
			\par\vspace{0.3em}
			\noindent\textit{Submitted manuscript}
			\par\vspace{0.3em}
			\noindent\textit{\hl{\textbf{D.C. Vu}}, V.T. Nguyen, D.H. Nguyen, M.C. Nguyen, T.V. Trung, and M.N. Vu}
	\end{soloitemize}
		% work experience
		
	
	\section*{Experience}
	\work{R\&D Robotics Engineer at VinRobotics, Vingroup}
	{Sep 2025 - Jul 2026}
	{Full-time, supervised by \href{https://scholar.google.com/citations?user=qyExc4QAAAAJ&hl=en}{\textit{Dr. Minh Nhat Vu}}\hfill Hanoi, Vietnam}
	{\begin{soloitemize}
			\item Led dynamic parameter identification for robotic manipulators: system identification, kinematic calibration, and friction modeling.
			\item Designed a real-time inverse kinematics solver achieving 100\% success rate with execution time below 40~\textmu s.
			\item Developed moDrdel-based control for dual-arm humanoid robots: fuzzy-based adaptive compliant control, computed torque control, gravity/friction compensation, and singular perturbation-based methods.
			\item Implemented MPC-based motion planning for dual-arm coordination using receding horizon optimization with Acados and CasADi (C++/Python/MATLAB).
			\item Designed time-optimal motion planning and trajectory generation, including Rubik's cube planning for single-arm manipulation.
			\item Designed motion planning for humanoid standup/sitdown motions for object lifting.
			\item Contributed to research activities, with papers submitted to \textit{IROS 2026}, \textit{IEEE-TASE}, and \textit{IEEE RA-L}.
	\end{soloitemize}}
	...
	{Jan 2025 - Dec 2026}
	{Contract (Hybrid), supervised by \href{https://scholar.google.com/citations?user=mI561CkAAAAJ&hl=en}{\textit{PhD. Chinh Hoang Duc}} and \href{https://scholar.google.com/citations?user=MlJ_2-wAAAAJ&hl=en}{\textit{Assoc.Prof.PhD. Tung Lam Nguyen}}\hfill Hanoi, Vietnam}
	{\begin{soloitemize}
			\item Contributed to a project on autonomous robot navigation integrating sensor networks and wireless communication.
			\item Developed a MuJoCo-based simulation framework for AUVs, incorporating underwater dynamics, sensing, disturbances, and communication constraints.
			\item Implemented and validated control algorithms for navigation, obstacle avoidance, and trajectory tracking.
			\item Collaborated on system integration and co-authored a peer-reviewed scientific publication.
	\end{soloitemize}}
	...
	\work{Research Project Assistant at HUST}
	{Mar 2025 - Dec 2025}
	{Contract (Hybrid), supervised by \href{https://scholar.google.com/citations?user=qyExc4QAAAAJ&hl=en}{\textit{PhD. Minh Nhat Vu}} and \href{https://scholar.google.com/citations?user=MlJ_2-wAAAAJ&hl=en}{\textit{Assoc.Prof.PhD. Tung Lam Nguyen}}\hfill Hanoi, Vietnam}
	{\begin{soloitemize}
			\item Worked on advanced control of a ship-mounted Stewart platform for marine applications (funded by KIST).
			\item Designed robust and safety-critical control strategies for parallel robotic systems under disturbances.
			\item Conducted modeling, simulation, and validation for nonlinear dynamic systems.
	\end{soloitemize}}

	\sepspace

	\work{Graduate Researcher at HUST}
	{May 2024 - Jul 2026}
	...
	{\begin{soloitemize}
			\item Conducted research on control of parallel robotic systems for maritime applications.
			\item Designed and implemented advanced control algorithms for a Stewart platform, validated through high-fidelity simulations (Simscape, MuJoCo).
			\item Built experimental setups including mechanical assembly, hardware integration, Linux real-time systems, and EtherCAT communication.
			\item Collaborated on publications and presented results to academic and industrial partners.
	\end{soloitemize}}
	...
	{\begin{soloitemize}
			\item Developed mathematical models and simulation environments for 3D ballbot systems, focusing on nonlinear dynamics and trajectory generation.
			\item Investigated advanced control strategies and implemented them in simulation and experimental setups.
			\item Authored and co-authored peer-reviewed journal papers, including publications in International Journal of Robust and Nonlinear Control and IEEE Access.
	\end{soloitemize}}
...
%		}
	...
	\activities{Invited review for}
		{
			\begin{soloitemize}
				\item \textit{Nonlinear Dynamics}
				\item \textit{International Conference on Intelligent Robots and Systems (IROS, 2026)}
				\item \textit{IEEE Robotics and Automation Letters (RA-L)}
				\item \textit{IEEE RO-MAN2026}
				\item \textit{Humanoid 2026}
			\end{soloitemize}}
...
%	\conference{International Conference on Intelligent Systems and Networks (Springer ICISN 2023)}{\textit{Hanoi, Vietnam}}
	...
	\award{NTU Research Scholarship}{Nanyang Technological University (NTU), Singapore}
	...
	% ================= Skills Section =================
	\section*{Skills}
	\skill{Programming}{Python, C/C++, MATLAB}
	
	\skill{Robotics \& Control}{Nonlinear control, Model Predictive Control (MPC), Control Barrier Functions (CBF), motion planning, system modeling and identification}
	
	\skill{Tools \& Frameworks}{ROS2, MuJoCo, Simulink/Simscape, Pinocchio, CasADi, Acados, VAMP, CAPT, Git}
	
	\skill{Systems \& Implementation}{Real-time Linux, IgH EtherCAT, hardware integration, motion capture systems}
	
	\skill{Research}{Scientific writing, peer-reviewed publications, technical presentations, literature review, experimental validation}
			
%	\section*{Languages}
%	\skill{Vietnamese} {Mother tongue.}
%	\skill{English} {IELTS Academic: Overall 6.5 (L:6.0, R:8.0, W:6.5, S:5.5)}
%	\section*{Skills}
%	
